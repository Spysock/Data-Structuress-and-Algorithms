...
__author__ = 'Abody Majeed'
__student_number__ = '101227327'
...
#         return 1 + max(self._height(node.left), self._height(node.right))
    ...
    def preorder_print(self) -> None:
        ...
        return _preorder_print(self._root)
    ...
    def inorder_print(self) -> None:
        ...
        def _inorder_print(node: "BinaryTree._Node") -> None:
            """Print binary tree rooted at node using an inorder traversal"""
            if node is None:
                return
        ...
        return _inorder_print(self._root)
    ...
    def postorder_print(self) -> None:
        ...
        return _postorder_print(self._root)

   # Exercise 7

    def count(self, item: any) -> int:
        """Return the number of occurrences of item in this binary tree."""
        def _count(node: 'BinaryTree._Node') -> int:
            """Print the number of occurrence of item in binary tree at specific node"""
            count = 0
            if node is None:
                return 0
            elif node.x == item:
                count += 1
            count += _count(node.left)
            count += _count(node.right)
            return count
...
def build_binary_tree() -> BinaryTree:
    ...
    rootnode.right = BinaryTree._Node([1,2])
    
    #Left Split
    rootnode.left.left = BinaryTree._Node([1,7])
...
def build_perfect_binary_tree() -> BinaryTree:
    ...
    #Left split
    left_side = rootnode.left
    left_side.left = BinaryTree._Node([1,7])
    left_side.right = BinaryTree._Node(9)
    
    #Right split
    right_side = rootnode.right
    right_side.left = BinaryTree._Node(3)
    right_side.right = BinaryTree._Node(6)
    
    return tree


def build_duplicate_binary_tree() -> BinaryTree:
    ...
    #First Split
    rootnode.left = BinaryTree._Node(2)
    rootnode.right = BinaryTree._Node(5)
    
    #Left split
    left_side = rootnode.left
    left_side.left = BinaryTree._Node(1)
    left_side.right = BinaryTree._Node(2)
    
    #Right split
    right_side = rootnode.right
    right_side.left = BinaryTree._Node([1,2])
    right_side.right = BinaryTree._Node([1,2])
